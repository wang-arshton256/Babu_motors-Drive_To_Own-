<div class="col-md-12">
  <div class="card mt-2">
    <div class="card-header">
      <h3 class="card-title">Beneficiaries who have completed payment
      </h3>
    </div>
    <!-- /.card-header -->
        ...
        <table  class="wangs_table table table-bordered table-striped ">
          <thead>
            <tr>
              ...
              <td class="bg-dark text-light">Backup Available</td>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="bg-dark text-light">{{ number_format($data->initial_payment, 3) }} UGX</td>
