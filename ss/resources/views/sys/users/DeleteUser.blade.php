...
<!-- The Modal -->
<div class="modal" id="DeleteUser{{ $data->id }}">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">

      <!-- Modal Header -->
      <div class="modal-header">
       <h4 class="modal-title text-danger">Confirm User Account Delete</h4>
      ...
      <div class="col-md-12">
            ...
            <div class="jumbotron ">
              ...
              Are you sure you want to delete this account attached to the user <span class="text-danger font-weight-bold"> {{ $data->name }}</span>
