...
<!-- The Modal -->
<div class="modal" id="DeletePay{{ $data->id }}">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">

      <!-- Modal Header -->
      <div class="modal-header">
       <h4 class="modal-title text-danger">Confirm   Delete Payment</h4>
      ...
      <div class="col-md-12">
            ...
            <div class="jumbotron ">
              ...
              Are you sure you want to delete this payment attached to the beneficiary <span class="text-danger font-weight-bold"> {{ $Beneficiary }}</span>
      ...
      <div class="modal-footer">
        <a href="{{ route('DeletePayment', ['id' =>$data->id ]) }}" class="btn confirmdelete btn-danger shadow-lg" style="display: none">Confirm Delete</a>
